            ...
            <div className={`mx-auto mt-8 max-w-screen-lg px-2  ${loading ? "opacity-20" : ""}`}>
                <div className="bg-white p-6 md:mx-auto ">
                    ...
                    <div className="text-center">
                        <h3 className="md:text-2xl text-base text-gray-900 font-semibold text-center">{userData?.paymentStatus === 'Credit' ? "Payment Done!" :userData?.paymentStatus === ''? "Payment Failed":""}</h3>
