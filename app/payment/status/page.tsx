...
const PaymentStatus: NextPage = () => {
    ...
    useEffect(() => {
        ...
        async function handleUser(userData: any) {
            if (userData) {
                userData.paymentID=paymentDetails.paymentID;
                userData.paymentStatus=paymentDetails.paymentStatus;
                userData.paymentRequestID=paymentDetails.paymentRequestID;
            ...
            <div className="mx-auto mt-8 max-w-screen-lg px-2">
                <div className="bg-white p-6  md:mx-auto">
                    ...
                    <div className="text-center">
                        <h3 className="md:text-2xl text-base text-gray-900 font-semibold text-center">{paymentDetails?.paymentStatus?"Payment Done!":"Payment Failed"}</h3>
                    ...
                    <table className="min-w-full border-separate border-spacing-y-2 border-spacing-x-2">
                        <tbody className="lg:border-gray-300 ">
                            ...
                            <tr className="">
                                ...
                                <td className="whitespace-no-wrap hidden py-4 text-sm font-normal text-gray-500 sm:px-6 lg:table-cell">{paymentDetails.payment_id ?? ";skelgkrglerk;nglrs;kgf"}</td>
                            </tr>
                            <tr className="">
                                <td width="50%" className="whitespace-no-wrap py-4 text-sm font-bold text-gray-900 sm:px-6">
                                    Date & Time
